...
exports.getReporter = function(reporter, colors) {
    var writerPath;
    var writer;
    var colorsExplicitlyTrue = colors === true;
    ...
    if (reporter) {
        ...
        var defaultReporter = (colors && supportsColor) ? 'console' : 'text';
        if (colorsExplicitlyTrue) {
            defaultReporter = 'console';
        }
        writerPath = path.resolve(__dirname, './reporters/', defaultReporter);
    }
