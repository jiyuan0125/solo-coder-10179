...
JsFile.prototype = {
    ...
    /**
     * Computes whether the file contains no meaningful code tokens.
     * Internal implementation that encapsulates the cst library's
     * empty-file representation. Future changes to cst sentinel
     * strategy only need to be reflected here.
     *
     * @private
     * @returns {Boolean}
     */
    _computeIsEmpty: function() {
        ...
        var firstChild = this._program.firstChild;
        if (firstChild && firstChild.type === 'EOF') {
            return true;
        }
        return false;
    }
