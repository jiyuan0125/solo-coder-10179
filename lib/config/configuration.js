...
Configuration.prototype._loadPreset = function(preset) {
    ...
    assert(this._presets.hasOwnProperty(preset), 'Preset "' + preset + '" does not exist');
    ...
    this._processConfig(presetData);
};
...
Configuration.prototype.registerRule = function(rule) {
    ...
    assert(
        ...
        'Rule must be an object or a constructor function'
    );
    assert(
        typeof rule.getOptionName === 'function',
        'Rule must implement getOptionName() method'
    );
    assert(
        typeof rule.configure === 'function',
        'Rule must implement configure() method'
    );
    assert(
        typeof rule.check === 'function',
        'Rule must implement check() method'
    );
